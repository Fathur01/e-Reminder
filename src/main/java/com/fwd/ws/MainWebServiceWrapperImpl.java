...
import com.fwd.model.passion.RfContentType;
...
import com.fwd.service.ContentTypeService;
...
import com.fwd.ws.request.ContentTypeRequest; //ftr
...
import com.fwd.ws.response.ContentTypeResponse; //ftr
...
public class MainWebServiceWrapperImpl extends BaseWebServiceWrapperImpl {
	...
	@Autowired
	protected PassionHubConnector connector;
	...
	public WebServiceResponse validate(HttpServletRequest httpRequest, @RequestBody MemberValidateRequest request)
			throws Exception {

		WebServiceResponse error = new WebServiceResponse();
		MemberValidateResponse response = connector.validateMemberInfo(request, this.newHttpHeaders(httpRequest),
				error);
		if (response == null) {
			return error;
		} else {
	...
	public WebServiceResponse login(HttpServletRequest httpRequest, @RequestBody MemberLoginRequest request)
			throws Exception {
	...
	public WebServiceResponse validateSessionKey(HttpServletRequest httpRequest)
	...
	public WebServiceResponse logout(HttpServletRequest httpRequest) throws com.fwd.ws.InvalidTokenException {
	...
	public WebServiceResponse viewActivity(HttpSession session, @RequestHeader(value = "userName") String userName,
			@RequestHeader(value = "token") String token, @RequestHeader(value = "language") String language)
					throws com.fwd.ws.InvalidTokenException {
		...
		try {
			...
			ResponseEntity<ActivityResponse> responseEntity = new ResponseEntity<ActivityResponse>(responseActivity,
					HttpStatus.OK);
			return responseEntity.getBody();
		} catch (HttpClientErrorException e) {
			logger.error(ExceptionUtils.getStackTrace(e));
			String errMsg = e.getCause() + e.getMessage();
			ResponseEntity<WebServiceResponse> responseEntity = new ResponseEntity<WebServiceResponse>(responseActivity,
					HttpStatus.OK);
	...
	public ActivityCreateResponse saveActivity(HttpSession session, @RequestHeader(value = "userName") String userName,
			@RequestHeader(value = "token") String token, @RequestHeader(value = "language") String language,
	...
	public WebServiceResponse viewContent(HttpSession session, @RequestHeader(value = "userName") String userName,
			@RequestHeader(value = "token") String token, @RequestHeader(value = "language") String language)
					throws com.fwd.ws.InvalidTokenException {
		...
		try {
			...
			ResponseEntity<ContentResponse> responseEntity = new ResponseEntity<ContentResponse>(responseContent,
					HttpStatus.OK);
			return responseEntity.getBody();
		} catch (HttpClientErrorException e) {
			logger.error(ExceptionUtils.getStackTrace(e));
			String errMsg = e.getCause() + e.getMessage();
			ResponseEntity<WebServiceResponse> responseEntity = new ResponseEntity<WebServiceResponse>(responseContent,
					HttpStatus.OK);
			responseEntity.getBody().setErrMsg(errMsg);
			return responseEntity.getBody();
		}
	...
	public ContentCreateResponse saveContent(HttpSession session, @RequestHeader(value = "userName") String userName,
			@RequestHeader(value = "token") String token, @RequestHeader(value = "language") String language,
		...
		try {
			...
			content.setImageUrl(request
					.getImageUrl());/*
									 * content.setNewsId(request.getNewsId());
									 * content.setPassionCode(request.
									 * getPassionCode());
									 */
	...
	public WebServiceResponse viewGift(HttpSession session, @RequestHeader(value = "userName") String userName,
			@RequestHeader(value = "token") String token, @RequestHeader(value = "language") String language)
					throws com.fwd.ws.InvalidTokenException {
		...
		try {
			...
			logger.error(ExceptionUtils.getStackTrace(e));
			String errMsg = e.getCause() + e.getMessage();
			ResponseEntity<WebServiceResponse> responseEntity = new ResponseEntity<WebServiceResponse>(responseGift,
					HttpStatus.OK);
			responseEntity.getBody().setErrMsg(errMsg);
			return responseEntity.getBody();
		}
	...
	public GiftCreateResponse saveGift(HttpSession session, @RequestHeader(value = "userName") String userName,
			@RequestHeader(value = "token") String token, @RequestHeader(value = "language") String language,
	...
	public WebServiceResponse viewHistory(HttpSession session, @RequestHeader(value = "userName") String userName,
			@RequestHeader(value = "token") String token, @RequestHeader(value = "language") String language)
					throws com.fwd.ws.InvalidTokenException {
		...
		try {
			...
			ResponseEntity<HistoryResponse> responseEntity = new ResponseEntity<HistoryResponse>(responseHistory,
					HttpStatus.OK);
			return responseEntity.getBody();
		} catch (HttpClientErrorException e) {
			logger.error(ExceptionUtils.getStackTrace(e));
			String errMsg = e.getCause() + e.getMessage();
			ResponseEntity<WebServiceResponse> responseEntity = new ResponseEntity<WebServiceResponse>(responseHistory,
					HttpStatus.OK);
			responseEntity.getBody().setErrMsg(errMsg);
			return responseEntity.getBody();
		}
	...
	public HistoryCreateResponse saveHistory(HttpSession session, @RequestHeader(value = "userName") String userName,
			@RequestHeader(value = "token") String token, @RequestHeader(value = "language") String language,
	...
	public WebServiceResponse viewMember(HttpSession session, @RequestHeader(value = "userName") String userName,
			@RequestHeader(value = "token") String token, @RequestHeader(value = "language") String language)
					throws com.fwd.ws.InvalidTokenException {
		...
		try {
			...
			ResponseEntity<MemberResponse> responseEntity = new ResponseEntity<MemberResponse>(responseMember,
					HttpStatus.OK);
			return responseEntity.getBody();
		} catch (HttpClientErrorException e) {
			logger.error(ExceptionUtils.getStackTrace(e));
			String errMsg = e.getCause() + e.getMessage();
			ResponseEntity<WebServiceResponse> responseEntity = new ResponseEntity<WebServiceResponse>(responseMember,
					HttpStatus.OK);
			responseEntity.getBody().setErrMsg(errMsg);
			return responseEntity.getBody();
		}
	...
	public MemberCreateResponse saveMember(HttpSession session, @RequestHeader(value = "userName") String userName,
			@RequestHeader(value = "token") String token, @RequestHeader(value = "language") String language,
		...
		try {
			if (request.getIsAgent() != "false")
				request.setIsAgent("1");
			else
				request.setIsAgent("0");
			if (request.getIsCorpCare() != "false")
				request.setIsCorpCare("1");
			else
				request.setIsCorpCare("0");
			if (request.getIsEmployee() != "false")
				request.setIsEmployee("1");
			else
				request.setIsEmployee("0");
			if (request.getIsPolicyHolder() != "false")
				request.setIsPolicyHolder("1");
			else
				request.setIsPolicyHolder("0");

			member.setMemberId(request.getMemberId()); // ftr 28/7/2016
			member.setCardNum(request.getCardNumber()); // ftr 28/7/2016
			member.setFirstName(request.getFirstName()); // ftr 28/7/2016
			member.setMiddleName(request.getMiddleName()); // ftr 28/7/2016
			member.setLastName(request.getLastName()); // ftr 28/7/2016
			member.setSurveyDate(DateUtils.toDate(request.getSurveyDate())); // ftr 28/7/2016
...
//			member.setUseridFk(Integer.valueOf(request.getUseridFk()));
	...
	public WebServiceResponse viewNews(HttpSession session, @RequestHeader(value = "userName") String userName,
			@RequestHeader(value = "token") String token, @RequestHeader(value = "language") String language)
					throws com.fwd.ws.InvalidTokenException {
		...
		try {
			...
			logger.error(ExceptionUtils.getStackTrace(e));
			String errMsg = e.getCause() + e.getMessage();
			ResponseEntity<WebServiceResponse> responseEntity = new ResponseEntity<WebServiceResponse>(responseNews,
					HttpStatus.OK);
			responseEntity.getBody().setErrMsg(errMsg);
			return responseEntity.getBody();
		}
	...
	public NewsCreateResponse saveNews(HttpSession session, @RequestHeader(value = "userName") String userName,
			@RequestHeader(value = "token") String token, @RequestHeader(value = "language") String language,
	...
	public WebServiceResponse viewPassion(HttpSession session, @RequestHeader(value = "userName") String userName,
			@RequestHeader(value = "token") String token, @RequestHeader(value = "language") String language)
					throws com.fwd.ws.InvalidTokenException {
		...
		try {
			...
			ResponseEntity<PassionResponse> responseEntity = new ResponseEntity<PassionResponse>(responsePassion,
					HttpStatus.OK);
			return responseEntity.getBody();
		} catch (HttpClientErrorException e) {
			logger.error(ExceptionUtils.getStackTrace(e));
			String errMsg = e.getCause() + e.getMessage();
			ResponseEntity<WebServiceResponse> responseEntity = new ResponseEntity<WebServiceResponse>(responsePassion,
					HttpStatus.OK);
			responseEntity.getBody().setErrMsg(errMsg);
			return responseEntity.getBody();
		}
	...
	public PassionCreateResponse savePassion(HttpSession session, @RequestHeader(value = "userName") String userName,
			@RequestHeader(value = "token") String token, @RequestHeader(value = "language") String language,
			@RequestBody PassionRequest request) throws com.fwd.ws.InvalidTokenException {

		validateSessionToken(session, userName, token);
		RfContentType contentType = new RfContentType();
		...
		try {
			...
			passion.setCreateDate(request.getCreateDate()); // Fathur 27-0702016
			passion.setCreateUserId(request.getCreateUserId()); // Fathur 27-0702016
			passion.setUpdateDate(new Date());
			passion.setUpdateUserId(userName);
			contentType.setRfContentType(contentType);
	...
	public WebServiceResponse viewPoint(HttpSession session, @RequestHeader(value = "userName") String userName,
			@RequestHeader(value = "token") String token, @RequestHeader(value = "language") String language)
					throws com.fwd.ws.InvalidTokenException {
		...
		try {
			...
			ResponseEntity<PointResponse> responseEntity = new ResponseEntity<PointResponse>(responsePoint,
					HttpStatus.OK);
			return responseEntity.getBody();
		} catch (HttpClientErrorException e) {
			logger.error(ExceptionUtils.getStackTrace(e));
			String errMsg = e.getCause() + e.getMessage();
			ResponseEntity<WebServiceResponse> responseEntity = new ResponseEntity<WebServiceResponse>(responsePoint,
					HttpStatus.OK);
			responseEntity.getBody().setErrMsg(errMsg);
			return responseEntity.getBody();
		}
	...
	public PointCreateResponse savePoint(HttpSession session, @RequestHeader(value = "userName") String userName,
			@RequestHeader(value = "token") String token, @RequestHeader(value = "language") String language,
	...
	public WebServiceResponse viewTrBalance(HttpSession session, @RequestHeader(value = "userName") String userName,
			@RequestHeader(value = "token") String token, @RequestHeader(value = "language") String language)
					throws com.fwd.ws.InvalidTokenException {
		...
		try {
			...
			ResponseEntity<TrBalanceResponse> responseEntity = new ResponseEntity<TrBalanceResponse>(responseTrBalance,
					HttpStatus.OK);
			return responseEntity.getBody();
		} catch (HttpClientErrorException e) {
			logger.error(ExceptionUtils.getStackTrace(e));
			String errMsg = e.getCause() + e.getMessage();
			ResponseEntity<WebServiceResponse> responseEntity = new ResponseEntity<WebServiceResponse>(
					responseTrBalance, HttpStatus.OK);
			responseEntity.getBody().setErrMsg(errMsg);
			return responseEntity.getBody();
		}
	...
	public TrBalanceCreateResponse saveTrBalance(HttpSession session,
			@RequestHeader(value = "userName") String userName, @RequestHeader(value = "token") String token,
			@RequestHeader(value = "language") String language, @RequestBody TrBalanceRequest request)
					throws com.fwd.ws.InvalidTokenException {
	...
	public WebServiceResponse viewTrPoint(HttpSession session, @RequestHeader(value = "userName") String userName,
			@RequestHeader(value = "token") String token, @RequestHeader(value = "language") String language)
					throws com.fwd.ws.InvalidTokenException {
		...
		try {
			...
			ResponseEntity<TrPointResponse> responseEntity = new ResponseEntity<TrPointResponse>(responseTrPoint,
					HttpStatus.OK);
			return responseEntity.getBody();
		} catch (HttpClientErrorException e) {
			logger.error(ExceptionUtils.getStackTrace(e));
			String errMsg = e.getCause() + e.getMessage();
			ResponseEntity<WebServiceResponse> responseEntity = new ResponseEntity<WebServiceResponse>(responseTrPoint,
					HttpStatus.OK);
			responseEntity.getBody().setErrMsg(errMsg);
			return responseEntity.getBody();
		}
	...
	public TrPointCreateResponse saveTrPoint(HttpSession session, @RequestHeader(value = "userName") String userName,
			@RequestHeader(value = "token") String token, @RequestHeader(value = "language") String language,
	...
	public WebServiceResponse viewTrRedeem(HttpSession session, @RequestHeader(value = "userName") String userName,
			@RequestHeader(value = "token") String token, @RequestHeader(value = "language") String language)
					throws com.fwd.ws.InvalidTokenException {
		...
		try {
			...
			ResponseEntity<TrRedeemResponse> responseEntity = new ResponseEntity<TrRedeemResponse>(responseTrRedeem,
					HttpStatus.OK);
			return responseEntity.getBody();
		} catch (HttpClientErrorException e) {
			logger.error(ExceptionUtils.getStackTrace(e));
			String errMsg = e.getCause() + e.getMessage();
			ResponseEntity<WebServiceResponse> responseEntity = new ResponseEntity<WebServiceResponse>(responseTrRedeem,
					HttpStatus.OK);
			responseEntity.getBody().setErrMsg(errMsg);
			return responseEntity.getBody();
		}
	...
	public TrRedeemCreateResponse saveTrRedeem(HttpSession session, @RequestHeader(value = "userName") String userName,
			@RequestHeader(value = "token") String token, @RequestHeader(value = "language") String language,
	...
	public WebServiceResponse viewUsers(HttpSession session, @RequestHeader(value = "userName") String userName,
			@RequestHeader(value = "token") String token, @RequestHeader(value = "language") String language)
					throws com.fwd.ws.InvalidTokenException {
		...
		try {
			...
			ResponseEntity<UsersResponse> responseEntity = new ResponseEntity<UsersResponse>(responseUsers,
					HttpStatus.OK);
			return responseEntity.getBody();
		} catch (HttpClientErrorException e) {
			logger.error(ExceptionUtils.getStackTrace(e));
			String errMsg = e.getCause() + e.getMessage();
			ResponseEntity<WebServiceResponse> responseEntity = new ResponseEntity<WebServiceResponse>(responseUsers,
					HttpStatus.OK);
			responseEntity.getBody().setErrMsg(errMsg);
			return responseEntity.getBody();
		}
	...
	public UsersCreateResponse saveUsers(HttpSession session, @RequestHeader(value = "userName") String userName,
			@RequestHeader(value = "token") String token, @RequestHeader(value = "language") String language,
	...
	public DropdownListResponse listUsers(
			HttpSession session/*
								 * ,
								 * 
								 * @RequestHeader(value="userName") String
								 * userName,
								 * 
								 * @RequestHeader(value="token") String token,
								 * 
								 * @RequestHeader(value="language") String
								 * language
								 */) throws com.fwd.ws.InvalidTokenException {
